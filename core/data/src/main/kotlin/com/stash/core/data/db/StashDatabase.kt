...
abstract class StashDatabase : RoomDatabase() {
    ...
    companion object {
         ...
         *
         * MUST stay the last member of this companion: it captures every
         * `MIGRATION_*` val by reference, and companion properties initialize
         * in declaration order — declared any earlier, the array would be
         * built from not-yet-initialized vals. When adding `MIGRATION_N_N+1`
         * above, append it here too; DatabaseModule's list is replaced by
         * this array so there is exactly ONE place to forget.
         */
