...
|---|---|---|
| `qbdlxEnabled` | `byoTokenLive \|\| relayConfigured \|\| customEndpointSet` | replaces `!allDead()` in `QbdlxQobuzSource.isEnabled()`/`isEnabledForStreaming()` (`allDead()` is deleted) |
