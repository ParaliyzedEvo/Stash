...
- **Open source**: Every line of code that touches credentials is in this repo and can be audited. See `core/auth/`, `data/spotify/`, `data/ytmusic/`, `core/data/.../discord/`, `data/download/src/main/kotlin/com/stash/data/download/lossless/qbdlx/`, `core/data/.../lastfm/` and `core/data/.../listenbrainz/`.
